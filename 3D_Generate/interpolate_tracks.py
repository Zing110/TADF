...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Process video with CoTracker')
    parser.add_argument('--video-path', type=str, required=True, 
                       help='Relative path to the input video file')
    parser.add_argument('--save-dir', type=str, required=True, 
                       help='Relative directory path to save the results')
    parser.add_argument('--model-path', type=str, default='checkpoints/cotracker2.pth',
                       help='Relative path to the CoTracker model checkpoint')
